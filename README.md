...
_____
## Задача 3 (Middle)
3) n x n 2D-matrix изображение, поверните изображение на 90 градусов (по часовой стрелке).  
Необходимо повернуть изображение на месте, что означает, что вам придется напрямую изменить входную 2D-матрицу. НЕ выделяйте еще одну 2D-матрицу и не выполняйте вращение.
